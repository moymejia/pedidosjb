...
class tipo_pago extends table
{
    ...
    public function __construct($PARAMETROS = null)
    {
        ...
        $this->ACCIONES['opcion_tipo_pago']         = "Opcion_tipo_pago";
        $this->ACCIONES['crear_tipo_pago']          = "Crear_tipo_pago";
        $this->ACCIONES['modificar_tipo_pago']      = "Modificar_tipo_pago";
        $this->ACCIONES['cambiar_estado_tipo_pago'] = "Cambiar_estado_tipo_pago";
    ...
    public function guardar_tipo_pago($PARAMETROS)
    {
        ...
        if (strlen($PARAMETROS['descripcion']) > 100) { //valida que la descripcion no tenga mas de 100 caracteres
            $this->last_error = 'La descripcion del tipo de pago no puede tener mas de 100 caracteres.';
            utils::report_error(validation_error, $PARAMETROS['descripcion'], $this->last_error);
