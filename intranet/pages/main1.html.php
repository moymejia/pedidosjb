            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="" alt="homepage" class="dark-logo" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <?php
                        //$IdMenuFavorito = $mysql->getresult("SELECT idmenu, menu, icono_menu FROM view_permisos_usuario WHERE usuario = '$usuario' GROUP BY menu  ORDER BY orden_menu");
                        //$result = $mysql->getresult("SELECT idmenu, menu, icono_menu FROM view_permisos_usuario WHERE usuario = '$usuario' GROUP BY menu  ORDER BY orden_menu");
                        // $contador = 0;
                        $result = $mysql->getresult("SELECT idmenu, menu, icono_menu FROM view_permisos_usuario WHERE usuario = '$usuario' GROUP BY menu  ORDER BY orden_menu");
                        if ($row = $mysql->getrowresult($result)) {
                            ...
                            // if ($contador = 1) {
                                //if ($menu = 'Favoritos') {
                                    ...
                                    $result_opciones = $mysql->getresult("SELECT idopcion, opcion FROM view_permisos_usuario WHERE usuario = '$usuario' and EsFavorito = 'SI' ORDER BY  orden_opcion ");
                                    while ($row_opcion = $mysql->getrowresult($result_opciones)) {
                                        $opcion = $row_opcion['opcion'];
                                        $idopcion = $row_opcion['idopcion'];
                                        echo "<li><a href=\"#\" onclick=\"return mostrar_opcion($idopcion,'$opcion','$menu')\">$opcion </a></li>";
                                    }  


                                //    echo "<li><a href=\"#\" onclick=\"return mostrar_opcion(1,'productos','Control comercial')\">productos </a></li>";
                                //    echo "<li><a href=\"#\" onclick=\"return mostrar_opcion(2,'categorias productos','Control comercial')\">categorias productos </a></li>";
                                //    $contador = 0;
                                // }
                            ...
                            //$row['menu'];
                               //$idmenu = $row['idmenu'];
                                ...
                                // $result_opciones = $mysql->getresult("SELECT idopcion, opcion FROM view_permisos_usuario WHERE usuario = '$usuario' and idmenu = '$idmenu' and EsFavorito = 'SI' ORDER BY  orden_opcion ");
                                // while ($row_opcion = $mysql->getrowresult($result_opciones)) {
                                //     $opcion = $row_opcion['opcion'];
                                //     $idopcion = $row_opcion['idopcion'];
                                //     echo "<li><a href=\"#\" onclick=\"return mostrar_opcion($idopcion,'$opcion','$menu')\">$opcion </a></li>";
                    ...
                    <?php
                            ...
                            $result = $mysql->getresult("SELECT idmenu, menu, icono_menu FROM view_permisos_usuario WHERE usuario = '$usuario' and MenuFavorito != 'SI' GROUP BY menu  ORDER BY orden_menu");
                            while ($row = $mysql->getrowresult($result)) {
                                ...
                                $result_opciones = $mysql->getresult("SELECT idopcion, opcion FROM view_permisos_usuario WHERE usuario = '$usuario' and MenuFavorito != 'SI' and idmenu = '$idmenu' ORDER BY  orden_opcion ");
                                while ($row_opcion = $mysql->getrowresult($result_opciones)) {
                                    $opcion = $row_opcion['opcion'];
                                    $idopcion = $row_opcion['idopcion'];
                                    echo "<li><a href=\"#\" onclick=\"return mostrar_opcion($idopcion,'$opcion','$menu')\">$opcion </a></li>";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" id='div_principal'>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body " id="contenedor_principal">
